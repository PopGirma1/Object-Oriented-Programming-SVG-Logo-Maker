const {Circle_Shape_SVG, Square_Shape_SVG, Triangle_Shape_SVG} = require("./lib/shapes.js")
...
describe('Circle_Shape_SVG', () => {
    test('renders correctly', () => {
      const shape = new Circle_Shape_SVG();
      var color =('blue')
      shape.setColor(color);
      expect(shape.render()).toEqual(`<Circle_Shape_SVG cx="50%" cy="50%" r="100" height="100%" width="100%" fill="${color}">`);
    });
  });
