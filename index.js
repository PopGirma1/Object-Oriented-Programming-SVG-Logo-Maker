...
const {Circle_Shape_SVG, Square_Shape_SVG, Triangle_Shape_SVG, Elpse_Shaped_SVG} = require("./lib/shapes");
// Imports the graceful-fs, inquirer, Circle_Shape_SVG, Square_Shape_SVG,Triangle_Shape_SVG and Elpse_Shaped_SVG modules.
...
class Svg{
    ...
    setTextElement(text,color){
        this.textElement = `<text x="150" y="125" font-size="60" font-family="Verdana" text-anchor="middle" fill="${color}">${text}</text>`
...
const questions = [
    ...
    },
    {
        ...
        choices: ["Circle_Shape_SVG", "Square_Shape_SVG", "Triangle_Shape_SVG" , "Elpse_Shaped_SVG"],
    },
];
